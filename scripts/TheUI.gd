...
func _ready() -> void:
	...
	_character_indicator_node = (
		$BottomRow/MinimapPanelContainer/MinimapSubViewportContainer/SubViewport/MinimapWorld/CharacterIndicator
		as Node2D
	)
	_asteroid_indicators_node = (
		$BottomRow/MinimapPanelContainer/MinimapSubViewportContainer/SubViewport/MinimapWorld/AsteroidIndicators
		as Node2D
	)
	_minimap_camera_node = (
		$BottomRow/MinimapPanelContainer/MinimapSubViewportContainer/SubViewport/MinimapWorld/MinimapCamera
		as Node2D
	)
